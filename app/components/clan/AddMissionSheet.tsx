...
export const AddMissionSheet = forwardRef(({ onSubmit, territories }: AddMissionSheetProps, ref) => {
  ...
  useEffect(() => {
    if (territories.length > 0 && !selectedTerritory) {
...
// Adicione o displayName após a definição do componente
AddMissionSheet.displayName = 'AddMissionSheet';